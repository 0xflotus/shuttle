  ...
  module V1
    class GroupsController < ApplicationController
      ...
      def params_for_create
        hash = params.require(:group).permit(:name, :article_names, :description)
        hash.merge(created_via_api: api_request?, creator_id: current_user.try(:id))
      end

      def params_for_update
        hash = params.require(:group).permit(:article_names, :description)
      ...
      def update_article_groups(group, update_params)
        ...
        if update_params[:update_params]
